    ...
    >
      <div class="w-full max-w-[1440px] mx-auto px-5 md:px-8 lg:px-12 xl:px-20">
        <div class="flex items-center justify-between gap-4 md:gap-3 lg:gap-4 h-16 md:h-20">
          ...
          <!-- Sign-up link + CTA Button + language switch. The order is the
               contract's: `logo · links · sign-up · CTA · locale`, ascending
               commitment left to right, with the plain link next to the pill
               that outranks it. NavSignupLink is `hidden` below 1280, so below
               that it costs this cluster no width at all — display:none drops
               out of the flex gap too. -->
...
import NavSignupLink from './Navbar/NavSignupLink.vue'
